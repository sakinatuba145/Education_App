...
class EnglishLanguage extends AppTranslationsKeys {
  ...
  Map<String, String> get keys =>{
    ...
    AppMessages.discover: 'Discover a new way of learning with modern course, expert teachers and unlimited opportunities',
